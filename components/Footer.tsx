    ...
    <footer>
      <div className="footer-content">
        <section className="update-history">
          <h3>更新履歴</h3>
          <ul>
            <li>2025.10.30 - 豪鬼のデータを新規実装。豪鬼のVBCを新規実装。フィルターのUXを変更。UIの軽微な修正。</li>
            <li>2025.10.27 - ラシードのデータを追加実装。</li>
            <li>2025.10.25 - ケンのデータを実装。VCBにケンの奮迅脚関連の考慮を実装。</li>
            <li>2025.10.22 - コンボ共有リンク機能を実装。PC版のみビジュアルコンボビルダー（VBC）を実装。</li>
        ...
        <section className="roadmap">
          <h3>今後のアップデート予定</h3>
          <ul>
            <li>全キャラクターのコンボデータを順次追加（公式のキャラクター使用率 ALLの上から順に実装予定）</li>
            <li>豪鬼の起き攻め充実化</li>
            <li>ユーザーがコンボを投稿・評価できるコミュニティ機能</li>
            <li>ビジュアルコンボビルダーでコンボ内容からドライブゲージ、SAゲージの回復量を確認できるようにする</li>
          </ul>
        </section>
